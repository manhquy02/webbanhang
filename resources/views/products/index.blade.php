                            ...
                            <div class="row align-items-center pb-3 border-bottom">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <!-- <select name="category_id" class="category-filter form-select" onchange="this.form.submit()">
                                            <option value="">Tất cả danh mục</option>
                                            <option value="1"{{request('category_id')==1 ?'selected':''}}>Điện thoại</option>
                                            <option value="2"{{request('category_id')==2 ?'selected':''}}>Máy tính bảng</option>
                                            <option value="3"{{request('category_id')==3 ?'selected':''}}>Phụ kiện</option>
                                        </select> -->
                                       ...
                                       <tr>
                                        ...
                                        <td class="text-end fs-5">
                                            ...
                                            <!-- <form action="{{route('products.update', $product->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                            <i class="bi bi-pencil-square edit-product" data-id={{$product->id}}></i>
                                            </form> -->
